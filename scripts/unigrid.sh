...
HEDGEHOG_BASE='hedgehog-0.0.2-x86_64-linux-gnu.bin'
# Java Download
JAVA_URL_LINK='https://download.oracle.com/java/17/latest/jdk-17_linux-x64_bin.deb'
# Direct Daemon Download if github has no releases.
DAEMON_DOWNLOAD='https://github.com/unigrid-project/daemon/releases/download/v2.9.7/unigrid-2.9.7-x86_64-linux-gnu.tar.gz'
DAEMON_DOWNLOAD_TESTNET='https://github.com/unigrid-project/daemon/releases/download/v2.9.7/unigrid-2.9.7-x86_64-linux-gnu.tar.gz'
...
#GROUNDHOG_DOWNLOAD=''
HEDGEHOG_DOWNLOAD='https://github.com/unigrid-project/hedgehog/releases/download/v0.0.2/hedgehog-0.0.2-x86_64-linux-gnu.bin'
#HEDGEHOG_DOWNLOAD=''
# Directory.
DIRECTORY='.unigrid'
# Conf File.
