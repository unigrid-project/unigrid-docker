...
DAEMON_DOWNLOAD='https://github.com/unigrid-project/daemon/releases/download/v2.9.8/unigrid-2.9.8-x86_64-linux-gnu.tar.gz'
DAEMON_DOWNLOAD_TESTNET='https://github.com/unigrid-project/daemon/releases/download/v2.9.8/unigrid-2.9.8-x86_64-linux-gnu.tar.gz'
